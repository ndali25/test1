function x19b_Points_Restrictive(file, save_filename, save_sheetname)
...
save_name = '_pointscores_restricted';
save_sheetname_mod = strcat(save_sheetname, "_point_restricted");
